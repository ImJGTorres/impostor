...
const screens = [
  ...
  { name: '03_Entrega_Telefono_Handover.png', url: 'http://localhost:3001/?screen=HANDOVER' },
  { name: '04_Filtro_Privacidad.png', url: 'http://localhost:3001/?screen=PRIVACY' },
  { name: '05_Revelacion_Civil.png', url: 'http://localhost:3001/?screen=REVEAL_CIVIL' },
  { name: '06_Revelacion_Impostor.png', url: 'http://localhost:3001/?screen=REVEAL_IMPOSTOR' },
  { name: '07_Ronda_Pistas_Debate.png', url: 'http://localhost:3001/?screen=CLUES' },
  { name: '08_Votacion_Sospechoso.png', url: 'http://localhost:3001/?screen=VOTING' },
  { name: '09_Inocente_Eliminado.png', url: 'http://localhost:3001/?screen=INNOCENT_ELIMINATED' },
